...
function onFrame(frame, deltaTime){
    ...
    for(var i in frame.handsMap){
        ...
        if(hand.type === "left"){
            ...
            leftPinchStrength = hand.pinchStrength;

            // must be before
            for(var i =0; i<3; i++){
                oldLeftPalmPosition[i] = leftPalmPosition[i];
            ...
            for(var i =0; i<3; i++){
                oldRightPalmPosition[i] = rightPalmPosition[i];
